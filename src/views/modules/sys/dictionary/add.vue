	...
	<el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
		...
		<el-container style="height: 500px; border: 1px solid #eee">
			<el-aside width="200px">
				<el-tree :data="treeData" :props="defaulttreeProps" node-key="id" @node-click="handleNodeClick" :default-expanded-keys="defaultExpandedKeys">
				</el-tree>
			</el-aside>
			...
			<el-main>
				<el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
					...
					<el-form-item label="父级" prop="pname">
						<el-input v-model="dataForm.pname" placeholder="父节点名称"></el-input>
					</el-form-item>
			...
			initTree() {
				this.$http({
					...
					if (data && data.code === 0) { 
						...
						this.treeData.forEach((elment, index, array) => {
							// 参数一是: 数组元素
							// 参数二是: 数组元素的索引
							// 参数三是：当前的数组
